...
export async function getCurrentUserPermissions() {
  ...
  if (email === 'tomvanbiene@gmail.com' || email === 'tomjo118735@gmail.com' || email === 'tom@equivest.com' || email === 'info@equivest.com' || email === 'info@equivestworldwide.com' || email === 'equivestbv@gmail.com' || email === 'heather@equivestworldwide.com' || email === 'info@equivest-worldwide.com' || email === 'investments@equivest-worldwide.com') {
    return {
      id: 'hardcoded-admin',
      email: email,
      role: 'superadmin',
