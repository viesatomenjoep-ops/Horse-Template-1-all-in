    ...
    <div className="min-h-screen bg-white  flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-primary  mb-4 tracking-tight">Welcome to Equivest</h1>
          <p className="text-lg text-gray-600 ">Please select your login portal to continue</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          
          {/* Admin Login Card */}
          <Link href="/admin/login" className="group relative bg-white  rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100  overflow-hidden flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-serif font-bold text-gray-900  mb-3">Admin Portal</h2>
          ...
          {/* Staff Login Card */}
          <Link href="/staff" className="group relative bg-white  rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100  overflow-hidden flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-serif font-bold text-gray-900  mb-3">Staff Portal</h2>
            <p className="text-gray-500  mb-8 max-w-xs">
