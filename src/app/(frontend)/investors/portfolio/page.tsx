import { getInvestmentHorses } from '@/app/actions/horse'
...
export default async function PrivatePortfolioPage() {
  ...
  try {
    horses = await getInvestmentHorses() || [];
  } catch (error: any) {
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-3xl p-12 border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-lg mx-auto">
              This portfolio is strictly reserved for our registered investors. Please log in to view our exclusive investment horses.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-baseline border-b border-gray-200 dark:border-gray-800 pb-6 mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-2">Exclusive overview of our current investment horses.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {horses.length === 0 ? (
            <div className="col-span-full py-12 text-center text-gray-500">
              No investment horses currently available in the portfolio.
            </div>
          ) : (
