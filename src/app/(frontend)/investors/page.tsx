    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen pt-6 pb-20">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <div className="mb-4">
            <a 
              href="mailto:Investments@equivest-worldwide.com?subject=Private%20Portfolio%20Access%20Request&body=Hi%20Equivest%20Team,%0A%0AI%20would%20like%20to%20become%20an%20investor%20and%20request%20private%20access%20credentials%20to%20view%20the%20portfolio.%0A%0AKind%20regards,"
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 mb-32">
        <div className="bg-primary dark:bg-gray-800 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
            ...
            <Link href="/horses" className="px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white/10 transition-all flex items-center justify-center gap-2">
