    ...
    <div className="bg-[#f8f9fa] min-h-screen font-sans pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-2">Vetting & Documents: {horse.name}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm text-center flex flex-col items-center">
            ...
            {horse.doc_vet_check ? (
              <a href={horse.doc_vet_check} target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-primary text-white rounded-lg font-bold hover:bg-secondary transition-colors">
                View Report
              </a>
            ) : (
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm text-center flex flex-col items-center">
            ...
            {horse.doc_xrays ? (
              <a href={horse.doc_xrays} target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-primary text-white rounded-lg font-bold hover:bg-secondary transition-colors">
                View X-Rays
              </a>
            ) : (
              <button disabled className="w-full py-3 bg-gray-100 text-gray-400 rounded-lg font-bold cursor-not-allowed">
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm text-center flex flex-col items-center">
            ...
            {horse.doc_passport ? (
              <a href={horse.doc_passport} target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-primary text-white rounded-lg font-bold hover:bg-secondary transition-colors">
                View Passport
              </a>
            ) : (
              <button disabled className="w-full py-3 bg-gray-100 text-gray-400 rounded-lg font-bold cursor-not-allowed">
