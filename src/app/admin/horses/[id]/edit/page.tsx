        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <input required type="number" defaultValue={horse.price_category} name="price_category" id="price_category" placeholder="e.g. 25000" className="mt-1 block w-full rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-primary sm:text-sm" />
            </div>
