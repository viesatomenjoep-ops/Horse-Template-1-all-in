        ...
        <table className="min-w-full divide-y divide-gray-200 ">
          <thead className="bg-white ">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500  uppercase tracking-wider">Excerpt</th>
          ...
          <tbody className="bg-white  divide-y divide-gray-200 ">
            {articles.length === 0 ? (
              ...
              articles.map((article: any) => (
                <tr key={article.id} className="hover:bg-white :bg-gray-700/50 transition-colors">
